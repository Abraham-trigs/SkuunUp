...
// app/page-redirect.tsx
// Purpose: Landing page for SkuunUp with welcome message and button to navigate to /app/dashboard using Ark palette
...
export default function PageRedirect() {
  ...
  return (
    <>
      <Head>
        <title>SkuunUp - School Management System</title>
        <meta
          name="description"
          content="Multi-Tenant school management system for all school levels"
        />
      </Head>

      <main className="min-h-screen flex flex-col items-center justify-center bg-ark-navy px-4 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-ark-lightblue mb-6">
          Welcome to SkuunUp
        </h1>
        <p className="text-ark-cyan text-lg md:text-xl mb-12">
          The ultimate school management system for all school levels
        </p>

        <button
          onClick={handleDashboardClick}
          className="px-8 py-4 text-white bg-ark-lightblue rounded-xl shadow-lg hover:bg-ark-cyan focus:outline-none focus:ring-4 focus:ring-ark-cyan transition-colors duration-200"
        >
          Go to Dashboard
        </button>
      </main>
...
/*
Design reasoning:
- Added welcome message and project description to introduce SkuunUp.
- Page metadata updated with project title and description for SEO and accessibility.
- Button uses Ark lightblue/cyan for clear call-to-action, consistent with theme.

Structure:
- Full-screen, centered flex column layout for hero/welcome section.
- Text and button aligned centrally for modern, clean UX.

Implementation guidance:
- Keep typography responsive with Tailwind text sizing.
- Background remains Ark navy; colors only applied where explicit text/button styling exists.
- Accessible focus ring ensures keyboard navigability.

Scalability insight:
- Easily extendable to add hero graphics, animations, or promotional content.
- Ark palette ensures consistent theming across future onboarding or landing pages.
*/
